...
Column::Column(Statement::Ptr& aStmtPtr, int aIndex) throw () :
    mStmtPtr(aStmtPtr),
    mIndex(aIndex)
{
}
...
const char* Column::getName() const  throw()
{
...
const char* Column::getOriginName() const throw ()
{
...
unsigned Column::getUInt() const  throw()
{
    return static_cast<unsigned>(getInt64());
}

// Return the 64bits integer value of the column specified by its index starting at 0
long long Column::getInt64() const  throw()
{
    return sqlite3_column_int64(mStmtPtr, mIndex);
}

// Return the double value of the column specified by its index starting at 0
double Column::getDouble() const  throw()
{
    return sqlite3_column_double(mStmtPtr, mIndex);
}

// Return a pointer to the text value (NULL terminated string) of the column specified by its index starting at 0
const char* Column::getText(const char* apDefaultValue /* = "" */) const  throw()
{
...
const void* Column::getBlob() const  throw()
{
...
int Column::getType() const  throw()
{
    return sqlite3_column_type(mStmtPtr, mIndex);
}

// Return the number of bytes used by the text value of the column
int Column::getBytes() const  throw()
{
