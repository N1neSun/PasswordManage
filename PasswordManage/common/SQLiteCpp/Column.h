...
public:
     ...
     */
    const char* getOriginName() const throw();
#endif
     ...
     */
    const char* getText(const char* apDefaultValue = "") const throw();
    /**
     ...
     *          thus you must copy it before using it beyond its scope (to a std::string for instance).
     */
    const void* getBlob() const throw();
    /**
